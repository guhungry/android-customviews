...
object VerticalLinearSpacingItemDecorationTest : Spek({
    ...
    given("Vertical LinearSpacingItemDecoration with $ITEMS items, spacing = $SPACING, includeEdge") {
        ...
        on("position 1 of $ITEMS") {
            ...
            it("should have correct ourRect") {
                ...
                assertThat(outRect.bottom, equalTo(3))
            }
        }
        ...
        on("position 2 of $ITEMS") {
            ...
            it("should have correct ourRect") {
                assertThat(outRect.top, equalTo(9))
                assertThat(outRect.left, equalTo(0))
                assertThat(outRect.right, equalTo(0))
                assertThat(outRect.bottom, equalTo(6))
            }
        }
        ...
        on("position 3 of $ITEMS") {
            ...
            it("should have correct ourRect") {
                assertThat(outRect.top, equalTo(6))
                assertThat(outRect.left, equalTo(0))
                assertThat(outRect.right, equalTo(0))
                assertThat(outRect.bottom, equalTo(9))
            }
        }
        ...
        on("position 4 of $ITEMS") {
            ...
            it("should have correct ourRect") {
                assertThat(outRect.top, equalTo(3))
                assertThat(outRect.left, equalTo(0))
                assertThat(outRect.right, equalTo(0))
    ...
    given("Vertical LinearSpacingItemDecoration with $ITEMS items, spacing = $SPACING, noEdge") {
